...
public class AddRecordHandler
{
	...
	/**
	 * Add a record. Start by creating and setting a
	 * faculty member then give it to the datastore utility.
	 * @param frame
	 */
	public void add(GUI frame, FacultyList fl)
	{
		...
		//Calendar dateOfHire = new GregorianCalendar(Integer.parseInt(frame.textField_year.getText()), frame.comboBox_month.getSelectedIndex() + 1 , 01);
		...
		fm.setRank((String) frame.comboBox_rank.getSelectedItem(), (String) frame.comboBox_rank.getSelectedItem());
		fm.setDegree((String) frame.comboBox_degree.getSelectedItem(), frame.txtInstitution.getText());

...
/**
 * The <code>FacultyMember</code> class contains relevant information pertaining
 * to a faculty member.
 */
public class FacultyMember
{
  ...
  /**
   * Set one year of evaluation (used in reading in data of whose years have
   * already been set)
   * 
   * @param yearOfEvaluation
   */
  ...
  /**
   * Method to calcualte years of evaluation when a new record is being added
   * 
   * @param year
   */
  ...
  /**
   * Method to set the promotion year (used when reading in data whos years have
  ...
  /**
   * Method of calculating the year of promotions when a new record is being
   * added
   * 
   * @param year
   */
  public void setNewPromos(String year, String promoRank)
  {
    this.promotion.calculateEligibility(year, promoRank);
  }
  ...
  /**
   * Method to compare faculty members
   * 
   */
  public static Comparator<FacultyMember> COMPARE_BY_NAME = new Comparator<FacultyMember>()
  {
    public int compare(FacultyMember one, FacultyMember other)
    {

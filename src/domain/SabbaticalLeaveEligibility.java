...
/**
 * The <code>SabbaticalEligibility</code> class contains relevant 
 * information pertaining to a faculty member's sabbatical leave.  This includes
 * the number of years of leave that are banked, the number of years of leave previously
...
public class SabbaticalLeaveEligibility
{
   ...
   */
   ...
   /**
   * Method calculates and returns the year that the next 
   * sabbatical leave can be taken.
   * @param dateOfHire the date the faculty member was hired

...
/**
 * The <code>EvaluationEligibility</code> class contains relevant 
 * information pertaining to a faculty member's evaluation.  This includes
 * the year tenure is granted, the level of last evaluation, a list of all 
 * evaluations conducted, and whether the faculty member must be reviewed further.
 */
public class EvaluationEligibility 
{
   ...
   */
   ...
   /**
   * Method calculates and returns the year of the next evaluation
   * to be conducted.  Method should not be called if noFurtherReview
   * is true.
   ...
   */
   ...
   /**
    * Method to set the current evaluation level
    * 1 year, 2 year, pre-tenure, tenure
